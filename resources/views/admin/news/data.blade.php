...
@foreach ($news as $new)
    <tr>
        ...
        <td>
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal" data-record_id="{{$new->id}}" id="accepted">{{__('Yes')}}</button>
            ...
            <a class="btn btn-link" href="news/{{$new->id}}">
            ...
            <a class="btn btn-link" href="news/{{$new->id}}/edit">
            ...
            <div style="direction: ltr">
                <div class="row">
                    ...
                    <div class="col-md-6 {{app()->getLocale() == 'en' ? 'text-right' : ''}}">
                        {{__('Showing')}} {{$news->firstItem()}} {{__('to')}} {{$news->lastItem()}} {{__('of')}} {{$news->total()}}
                    </div>
                </div>
            </div>
        </td>
