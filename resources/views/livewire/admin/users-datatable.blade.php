<div>
                ...
                @foreach ($users as $user)
                    <tr scope="row">
                        ...
                        <td>
                            ...
                            data-action="/admin/users/{{$user->id}}">
                            ...
                            <div class="modal fade" id="deleteModal{{$user->id}}" tabindex="-1" role="dialog" aria-hidden="false">
                                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button wire:click="delete({{$user->id}})" type="button" class="btn btn-primary" data-dismiss="modal">
                                                {{__('Yes')}}
                                            </button>
                            ...
                            <a class="btn btn-link" href="/admin/users/{{$user->id}}">
    ...
    <div class="d-flex justify-content-between mt-4" dir="{{app()->getLocale() == 'ar'? 'ltr': ''}}">
        <div>{{ $users->links() }}</div>
        <div>
            {{__('Showing')}} {{$users->firstItem()}} {{__('To')}} {{$users->lastItem()}} {{__('out of')}} {{$users->total()}}
        </div>
    </div>
</div>