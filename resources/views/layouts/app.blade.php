...
<body>
    ...
    <div id="app"> 
        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm bg-white border-0">
            ...
            <div class="container">
                <div class="d-block d-sm-none bg-light w-100 border-top">
                    ...
                    <ul class="navbar-nav pr-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right text-right" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="/pages/welcome">الكلمة الترحيبية</a>
                              <a class="dropdown-item" href="/pages/laws">قوانين وتشريعات</a>
                              <a class="dropdown-item" href="/pages/about">ملامح عن الجهاز</a>
                              <a class="dropdown-item" href="{{asset('docs/13-2013.pdf')}}" target="_blank">النظام الأساسي للدولة</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              مركز الإعلام والتوعية
                            </a>
                            <div class="dropdown-menu dropdown-menu-right text-right" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="/news">أرشيف الأخبار</a>
                              <a class="dropdown-item" href="#">الإنتاج المرئي</a>
                              <a class="dropdown-item" href="#">الإنتاج المسموع</a>
                              <a class="dropdown-item" href="#">الإصدارات المطبوعة</a>
                              <a class="dropdown-item" href="#">الإصدارات الإلكترونية</a>
                              <a class="dropdown-item" href="#">أجندة الفعاليات</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-right text-right" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="/complaint/create">نافذة البلاغات</a>
                              <a class="dropdown-item" href="/pages/fdgo">إقرار الذمة المالية</a>
                              <a class="dropdown-item" href="#">الوظائف</a>
                              <a class="dropdown-item" href="#">المناقصات</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-right text-right" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="/pages/antiCorruption">مكافحة الفساد</a>
                              <a class="dropdown-item" href="/">التخطيط والتدريب</a>
                              <a class="dropdown-item" href="/">العلاقات الدولية</a>
                              <a class="dropdown-item" href="/">الأدلة والمعايير الرقابية</a>
                            </div>
                        </li> --}}
                    </ul>
