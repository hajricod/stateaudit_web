...
<div class="container">
    <div class="row">
        <div class="col-md-12 bg-white pt-5 pb-3 min-h-80">
            @if (lang() == 'ar')
            <article>
                <h4>ملامح عن الجهاز</h4>
                <hr>
                <ul class="nav nav-pills mb-3 pr-0" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="pills-history-tab" data-toggle="pill" href="#pills-history" role="tab" aria-controls="pills-history" aria-selected="true">
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="pills-specialization-tab" data-toggle="pill" href="#pills-specialization" role="tab" aria-controls="pills-specialization" aria-selected="false">
                        إختصاصات الجهاز
                      </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-development-tab" data-toggle="pill" href="#pills-development" role="tab" aria-controls="pills-development" aria-selected="false">
                ...
                <div class="tab-content card p-3 text-justify" id="pills-tabContent">
