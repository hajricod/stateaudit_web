        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                <div class="d-flex justify-content-end">
                    <button wire:click="resetFilter()" class="btn btn-sm btn-primary" id="clearFilter">
            ...
            <tbody>
                @foreach ($complaints as $complaint)
                    <tr scope="row">
                        ...
                        <td><input wire:change="addToItmes({{$complaint->id}})" type="checkbox" name="record" id="{{$complaint->id}}"></td>
