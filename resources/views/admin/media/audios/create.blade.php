...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <form action="/admin/audios" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if ($latestAudio)
                        ...
                        <div class="form-group">
                            <label for="rank">{{__('Rank')}}</label>
                            <input class="form-control" type="number" name="rank" id="rank" value="{{$latestAudio ? $latestAudio->rank+1 : 1}}">
