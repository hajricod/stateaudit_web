...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $big_buttons = [
            ...
            [
                "title" => __('Financial Disclosure for Government Official'),
                "url"   => "/fdgo",
                "icon"  => 
            ...
            [
                "title" =>  __('Media and Awareness Center'),
                "url"   => "/media",
                "icon"  => 
            ...
            [
                "title" => __('Audit Manuals and Standards'),
                "url"   => "/standards",
                "icon"  =>
            ...
            [
                "title" => __('E-transformation'),
                "url"   => "/pages/etransformation",
                "icon"  =>
